...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      provider: () => new HDWalletProvider(JSON.parse(mnemonic), 'https://goerli.infura.io/v3/8b89094fea30422cbb87ee199c924397'),//'https://http-testnet.huobichain.com'),// 'https://http-testnet.hecochain.com'),
      network_id: 5
    },
    bsc: {
